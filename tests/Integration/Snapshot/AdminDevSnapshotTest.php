...
/**
 * Snapshot test: verifies admin:dev --help output matches the fixture byte-for-byte.
 */
#[CoversNothing]
final class AdminDevSnapshotTest extends TestCase
{
    ...
    public function helpOutputMatchesFixtureByteForByte(): void
    {
        $fixture = file_get_contents(
            __DIR__ . '/../../Fixtures/snapshots/admin__dev.help.stdout',
        );
        self::assertNotFalse($fixture, 'Fixture file must exist');

        [$stdout, $exitCode] = $this->runHelp('admin:dev');

        self::assertSame(0, $exitCode, 'admin:dev --help must exit 0');
        self::assertSame($fixture, $stdout, 'admin:dev --help output must match fixture byte-for-byte');
    }
