...
/**
 * Snapshot test: verifies make:migration --help output matches the fixture byte-for-byte.
 */
#[CoversNothing]
final class MakeMigrationSnapshotTest extends TestCase
{
    ...
    public function helpOutputMatchesFixtureByteForByte(): void
    {
        $fixture = file_get_contents(
            __DIR__ . '/../../Fixtures/snapshots/make__migration.help.stdout',
        );
        self::assertNotFalse($fixture, 'Fixture file must exist');

        [$stdout, $exitCode] = $this->runHelp('make:migration');

        self::assertSame(0, $exitCode, 'make:migration --help must exit 0');
        self::assertSame($fixture, $stdout, 'make:migration --help output must match fixture byte-for-byte');
    }
