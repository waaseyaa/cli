...
/**
 * Snapshot test: verifies make:public --help output matches the fixture byte-for-byte.
 */
#[CoversNothing]
final class MakePublicSnapshotTest extends TestCase
{
    ...
    public function helpOutputMatchesFixtureByteForByte(): void
    {
        $fixture = file_get_contents(
            __DIR__ . '/../../Fixtures/snapshots/make__public.help.stdout',
        );
        self::assertNotFalse($fixture, 'Fixture file must exist');

        [$stdout, $exitCode] = $this->runHelp('make:public');

        self::assertSame(0, $exitCode, 'make:public --help must exit 0');
        self::assertSame($fixture, $stdout, 'make:public --help output must match fixture byte-for-byte');
    }
