...
/**
 * Snapshot test: verifies optimize --help output matches the WP01 fixture byte-for-byte.
 */
#[CoversNothing]
final class OptimizeSnapshotTest extends TestCase
{
    ...
    public function helpOutputMatchesFixtureByteForByte(): void
    {
        $fixture = file_get_contents(
            __DIR__ . '/../../Fixtures/snapshots/optimize.help.stdout',
        );
        self::assertNotFalse($fixture, 'Fixture file must exist');

        [$stdout, $exitCode] = $this->runHelp('optimize');

        self::assertSame(0, $exitCode, 'optimize --help must exit 0');
        self::assertSame($fixture, $stdout, 'optimize --help output must match fixture byte-for-byte');
    }
