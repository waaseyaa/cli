...
/**
 * Snapshot test: verifies make:entity --help output matches the fixture byte-for-byte.
 */
#[CoversNothing]
final class MakeEntitySnapshotTest extends TestCase
{
    ...
    public function helpOutputMatchesFixtureByteForByte(): void
    {
        $fixture = file_get_contents(
            __DIR__ . '/../../Fixtures/snapshots/make__entity.help.stdout',
        );
        self::assertNotFalse($fixture, 'Fixture file must exist');

        [$stdout, $exitCode] = $this->runHelp('make:entity');

        self::assertSame(0, $exitCode, 'make:entity --help must exit 0');
        self::assertSame($fixture, $stdout, 'make:entity --help output must match fixture byte-for-byte');
    }
