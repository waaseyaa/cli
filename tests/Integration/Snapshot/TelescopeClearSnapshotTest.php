...
/**
 * Snapshot test: verifies telescope:clear --help output matches the WP01 fixture byte-for-byte.
 */
#[CoversNothing]
final class TelescopeClearSnapshotTest extends TestCase
{
    ...
    public function helpOutputMatchesFixtureByteForByte(): void
    {
        $fixture = file_get_contents(
            __DIR__ . '/../../Fixtures/snapshots/telescope__clear.help.stdout',
        );
        self::assertNotFalse($fixture, 'Fixture file must exist');

        [$stdout, $exitCode] = $this->runHelp('telescope:clear');

        self::assertSame(0, $exitCode, 'telescope:clear --help must exit 0');
        self::assertSame($fixture, $stdout, 'telescope:clear --help output must match fixture byte-for-byte');
    }
