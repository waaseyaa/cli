...
/**
 * Snapshot test: verifies about --help output matches the fixture byte-for-byte.
 */
#[CoversNothing]
final class AboutSnapshotTest extends TestCase
{
    ...
    public function helpOutputMatchesFixtureByteForByte(): void
    {
        $fixture = file_get_contents(
            __DIR__ . '/../../Fixtures/snapshots/about.help.stdout',
        );
        self::assertNotFalse($fixture, 'Fixture file must exist');

        [$stdout, $exitCode] = $this->runHelp('about');

        self::assertSame(0, $exitCode, 'about --help must exit 0');
        self::assertSame($fixture, $stdout, 'about --help output must match fixture byte-for-byte');
    }
