...
/**
 * Snapshot test: verifies telescope --help output matches the WP01 fixture byte-for-byte.
 */
#[CoversNothing]
final class TelescopeListSnapshotTest extends TestCase
{
    ...
    public function helpOutputMatchesFixtureByteForByte(): void
    {
        $fixture = file_get_contents(
            __DIR__ . '/../../Fixtures/snapshots/telescope.help.stdout',
        );
        self::assertNotFalse($fixture, 'Fixture file must exist');

        [$stdout, $exitCode] = $this->runHelp('telescope');

        self::assertSame(0, $exitCode, 'telescope --help must exit 0');
        self::assertSame($fixture, $stdout, 'telescope --help output must match fixture byte-for-byte');
    }
