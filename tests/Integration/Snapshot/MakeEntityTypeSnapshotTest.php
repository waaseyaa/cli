...
/**
 * Snapshot test: verifies make:entity-type --help output matches the fixture byte-for-byte.
 */
#[CoversNothing]
final class MakeEntityTypeSnapshotTest extends TestCase
{
    ...
    public function helpOutputMatchesFixtureByteForByte(): void
    {
        $fixture = file_get_contents(
            __DIR__ . '/../../Fixtures/snapshots/make__entity-type.help.stdout',
        );
        self::assertNotFalse($fixture, 'Fixture file must exist');

        [$stdout, $exitCode] = $this->runHelp('make:entity-type');

        self::assertSame(0, $exitCode, 'make:entity-type --help must exit 0');
        self::assertSame($fixture, $stdout, 'make:entity-type --help output must match fixture byte-for-byte');
    }
