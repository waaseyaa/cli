...
use Waaseyaa\CLI\Provider\NorthCloudServiceProvider;

/**
 * Snapshot tests: verify northcloud:sync --help output matches the fixture byte-for-byte.
 *
 * The fixture (northcloud__sync.help.stdout) was generated from the Symfony Command at
 * WP22 port time and serves as the immutable native-renderer baseline.
 */
#[CoversNothing]
final class NcSyncSnapshotTest extends TestCase
{
    ...
    {
        return [
            'northcloud:sync' => ['northcloud:sync', 'northcloud__sync.help.stdout'],
        ];
    }
